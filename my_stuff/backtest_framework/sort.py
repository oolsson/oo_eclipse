...
index = pd.date_range('1/1/2000', periods=7)
df = pd.DataFrame([[1,2,3],[2,3,1],[1,3,2],[1,3,2],[1,3,2],[1,3,2],[1,3,2]], index=index,
               columns=['C', 'B', 'A'])
rank=df.rank(axis=1)

ret = pd.DataFrame([[0.1,0.2,0.3],[0.2,0.3,0.1],[0.1,0.3,0.2],[0.1,0.3,0.2],[0.1,0.3,0.2],[0.1,0.3,0.2],[0.1,0.3,0.2]], index=index,
               columns=['C', 'B', 'A'])
